...
VALUES		('BUILDINGCLASS_JFD_TOJO', 	'BUILDING_JFD_TOJO_PUPPET_DUMMY', 	'TXT_KEY_BUILDING_JFD_TOJO_PUPPET_DUMMY');
--==========================================================================================================================	
-- Buildings
--==========================================================================================================================	
INSERT OR REPLACE INTO Buildings 	
			(Type, 						 		BuildingClass, 				PlotCultureCostModifier,	GreatWorkCount,	Cost,	FaithCost,	PrereqTech,	Description, 								Help,											NeverCapture, 	NukeImmune)
VALUES		('BUILDING_JFD_TOJO_PUPPET_DUMMY',	'BUILDINGCLASS_JFD_TOJO',	-50,						-1,				-1,		-1, 		null, 		'TXT_KEY_BUILDING_JFD_TOJO_PUPPET_DUMMY',	'TXT_KEY_BUILDING_JFD_TOJO_PUPPET_DUMMY_HELP',	1,				1);
