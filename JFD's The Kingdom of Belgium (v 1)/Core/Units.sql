...
CREATE TRIGGER BelgianWorkerBuildTrigger
AFTER INSERT ON Unit_Builds
WHEN 'UNIT_WORKER' = NEW.UnitType
BEGIN
	INSERT INTO Unit_Builds
			(UnitType, 					BuildType)
	VALUES	('UNIT_JFD_BELGIAN_WORKER',	NEW.BuildType);
END;
--==========================================================================================================================
-- Unit_FreePromotions
--==========================================================================================================================
...
VALUES		('UNIT_JFD_CHASSEUR', 	'PROMOTION_JFD_CHASSEUR_INFO'),
			('UNIT_JFD_CHASSEUR', 	'PROMOTION_MOBILITY'),
			('UNIT_JFD_CHASSEUR', 	'PROMOTION_WOODSMAN'),
