...
SELECT		('UNIT_JFD_LENIN_WORKER'),	5,				20,								PrereqTech, Class, Capture, 0,				Cost, Moves, CivilianAttackPriority, Domain, ('UNITAI_MUSICIAN'),	Description, Civilopedia, Help, Strategy, AdvancedStartCost, WorkRate,	CombatLimit, UnitArtInfo, UnitArtInfoEraVariation, UnitFlagIconOffset, PortraitIndex, IconAtlas
...
CREATE TRIGGER LeninWorkerBuildTrigger
AFTER INSERT ON Unit_Builds
WHEN 'UNIT_WORKER' = NEW.UnitType
BEGIN
	INSERT INTO Unit_Builds
			(UnitType, 					BuildType)
	VALUES	('UNIT_JFD_LENIN_WORKER',	NEW.BuildType);
END;
--==========================================================================================================================
-- Unit_ClassUpgrades
--==========================================================================================================================
