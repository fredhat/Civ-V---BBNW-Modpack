...
SELECT		Class, 	('UNIT_JFD_SS'), 	0,				Special, PrereqTech, Combat, Cost, 	FaithCost, 	RequiresFaithPurchaseEnabled, 4, 		HurryCostModifier, 8,						WorkRate, Domain, ('UNITAI_SCIENTIST'),	('TXT_KEY_JFD_SS_DESC'),	('TXT_KEY_JFD_SS_TEXT'),	('TXT_KEY_JFD_SS_STRATEGY'), 	('TXT_KEY_JFD_SS_HELP'), 	MilitarySupport, MilitaryProduction, Pillage, ObsoleteTech, AdvancedStartCost, GoodyHutUpgradeUnitClass, CombatLimit, XPValueAttack, XPValueDefense, Conscription, UnitArtInfoEraVariation,	UnitArtInfo, UnitFlagAtlas, UnitFlagIconOffset,	3, 				('JFD_NAZI_GERMANY_ATLAS'), MoveRate
FROM Units WHERE (Type = 'UNIT_GREAT_GENERAL');

UPDATE Units 
SET Help = 'TXT_KEY_UNIT_JFD_PANZER_HELP', Strategy = 'TXT_KEY_UNIT_JFD_PANZER_STRATEGY'
...
VALUES		('UNIT_JFD_WEHRMACHT', 	'PROMOTION_BLITZ'),
			('UNIT_GERMAN_PANZER', 	'PROMOTION_FREE_PILLAGE_MOVES'),
...
INSERT INTO Unit_UniqueNames 
			(UnitType, 				UniqueName)
VALUES		('UNIT_JFD_SS', 		'TXT_KEY_GREAT_PERSON_JULIUS_SCHRECK'),
			('UNIT_JFD_SS', 		'TXT_KEY_GREAT_PERSON_JOSEPH_BERCHTOLD'),
			('UNIT_JFD_SS', 		'TXT_KEY_GREAT_PERSON_ERHARD_HEIDEN'),
