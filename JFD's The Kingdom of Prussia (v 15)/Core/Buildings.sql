...
INSERT INTO Buildings 	
			(Type, 										SpecialistType,						SpecialistCount, FreeStartEra, GoldMaintenance, PrereqTech, BuildingClass, Cost,	FaithCost,	NukeImmune, MinAreaSize, NeverCapture,	Description, 										Civilopedia, 	Help, 														Strategy,	PortraitIndex, 	IconAtlas,	ShowInPedia)
SELECT		('BUILDING_JFD_PRUSSIAN_BARRACKS'),			'SPECIALIST_JFD_PRUSSIAN_GENERAL',	2,				 FreeStartEra, GoldMaintenance, PrereqTech, BuildingClass, Cost,	-1,			NukeImmune, MinAreaSize, 1,				('TXT_KEY_BUILDING_JFD_PRUSSIAN_BARRACKS'), 		Civilopedia, 	('TXT_KEY_BUILDING_JFD_PRUSSIAN_BARRACKS_HELP'), 			Strategy,	PortraitIndex, 	IconAtlas,	0
FROM Buildings WHERE (Type = 'BUILDING_BARRACKS');

INSERT INTO Buildings 	
			(Type, 										SpecialistType,						SpecialistCount, FreeStartEra, GoldMaintenance, PrereqTech, BuildingClass, Cost,	FaithCost,	NukeImmune, MinAreaSize, NeverCapture,	Description, 										Civilopedia, 	Help, 														Strategy,	PortraitIndex, 	IconAtlas,	ShowInPedia)
SELECT		('BUILDING_JFD_PRUSSIAN_ARMORY'),			'SPECIALIST_JFD_PRUSSIAN_GENERAL',	2,				 FreeStartEra, GoldMaintenance, PrereqTech, BuildingClass, Cost,	-1,			NukeImmune, MinAreaSize, 1,				('TXT_KEY_BUILDING_JFD_PRUSSIAN_ARMORY'), 			Civilopedia, 	('TXT_KEY_BUILDING_JFD_PRUSSIAN_ARMORY_HELP'),				Strategy,	PortraitIndex, 	IconAtlas,	0
FROM Buildings WHERE (Type = 'BUILDING_ARMORY');

INSERT INTO Buildings 	
			(Type, 										SpecialistType,						SpecialistCount, FreeStartEra, GoldMaintenance, PrereqTech, BuildingClass, Cost, 	FaithCost,	NukeImmune, MinAreaSize, NeverCapture,	Description, 										Civilopedia, 	Help, 														Strategy,	PortraitIndex, 	IconAtlas,	ShowInPedia)
SELECT		('BUILDING_JFD_PRUSSIAN_MILITARY_ACADEMY'), 'SPECIALIST_JFD_PRUSSIAN_GENERAL',	2,				 FreeStartEra, GoldMaintenance, PrereqTech, BuildingClass, Cost, 	-1,			NukeImmune, MinAreaSize, 1,				('TXT_KEY_BUILDING_JFD_PRUSSIAN_MILITARY_ACADEMY'), Civilopedia, 	('TXT_KEY_BUILDING_JFD_PRUSSIAN_MILITARY_ACADEMY_HELP'),	Strategy,	PortraitIndex, 	IconAtlas,	0
