...
VALUES	    ('BUILDINGCLASS_JFD_SWISS_MANPOWER',	'BUILDING_JFD_SWISS_MANPOWER', 	'TXT_KEY_CIVIL_WAR_SCENARIO_RESOURCE_MANPOWER'),
			('BUILDINGCLASS_JFD_SWISS_GOLD', 		'BUILDING_JFD_SWISS_GOLD', 		'TXT_KEY_BUILDING_JFD_SWISS_GOLD');		
--==========================================================================================================================	
-- Buildings
--==========================================================================================================================		
...
VALUES		('BUILDING_JFD_SWISS_MANPOWER',			 'BUILDINGCLASS_JFD_SWISS_MANPOWER', 	-1, 	-1,			-1, 			0,  				null,			10,							'TXT_KEY_JFD_BUILDING_MANPOWER',	'TXT_KEY_JFD_BUILDING_MANPOWER_HELP'),
			('BUILDING_JFD_SWISS_MANPOWER_HANDICAP', 'BUILDINGCLASS_JFD_SWISS_MANPOWER', 	-1, 	-1,			-1, 			0,  				null,			5,							'TXT_KEY_JFD_BUILDING_MANPOWER',	'TXT_KEY_JFD_BUILDING_MANPOWER_HANDICAP_HELP'),
			('BUILDING_JFD_SWISS_GOLD',				 'BUILDINGCLASS_JFD_SWISS_GOLD', 		-1, 	-1,			-1, 			0,  				null,			0,							'TXT_KEY_BUILDING_JFD_SWISS_GOLD',	'TXT_KEY_BUILDING_JFD_SWISS_GOLD');
