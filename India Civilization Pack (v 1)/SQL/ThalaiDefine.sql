...
SELECT	('ART_DEF_UNIT_CHOLA_THALAI_THIRVAI'), 	3, 				Formation
FROM ArtDefine_UnitInfos WHERE Type = 'ART_DEF_UNIT_CARAVEL';
	
INSERT INTO ArtDefine_UnitInfoMemberInfos
		(UnitInfoType,							UnitMemberInfoType,				NumMembers)
VALUES	('ART_DEF_UNIT_CHOLA_THALAI_THIRVAI', 	'ART_DEF_UNIT_MEMBER_THALAI', 	1);
...
SELECT	('ART_DEF_UNIT_MEMBER_THALAI'), EnableActions, DisableActions, MoveRadius, ShortMoveRadius, ChargeRadius, AttackRadius, RangedAttackRadius, MoveRate, ShortMoveRate, TurnRateMin, TurnRateMax, TurnFacingRateMin, TurnFacingRateMax, RollRateMin, RollRateMax, PitchRateMin, PitchRateMax, LOSRadiusScale, TargetRadius, TargetHeight, HasShortRangedAttack, HasLongRangedAttack, HasLeftRightAttack, HasStationaryMelee, HasStationaryRangedAttack, HasRefaceAfterCombat, ReformBeforeCombat, HasIndependentWeaponFacing, HasOpponentTracking, HasCollisionAttack, AttackAltitude, AltitudeDecelerationDistance, OnlyTurnInMovementActions, RushAttackFormation
...
SELECT	('ART_DEF_UNIT_MEMBER_THALAI'), 0.2, 	ZOffset, Domain, ('thalaithirvai.fxsxml'), 	MaterialTypeTag, MaterialTypeSoundOverrideTag
