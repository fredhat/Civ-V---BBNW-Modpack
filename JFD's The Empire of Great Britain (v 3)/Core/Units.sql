...
SELECT		 Class, 	('UNIT_JFD_REDCOAT'), 		PrereqTech, Combat, Cost-15, 	FaithCost-30,	RequiresFaithPurchaseEnabled,	Moves, 	CombatClass, Domain, DefaultUnitAI, ('TXT_KEY_UNIT_JFD_REDCOAT'), 	('TXT_KEY_UNIT_JFD_REDCOAT_TEXT'), 	('TXT_KEY_UNIT_JFD_REDCOAT_STRATEGY'), 	('TXT_KEY_UNIT_HELP_JFD_REDCOAT'),  MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, AdvancedStartCost, CombatLimit, ObsoleteTech, XPValueDefense, GoodyHutUpgradeUnitClass, ('ART_DEF_UNIT_JFD_REDCOAT'),  0,					('JFD_UNIT_FLAG_REDCOAT_ATLAS'),	3, 				('JFD_GREAT_BRITAIN_ATLAS')
FROM Units WHERE (Type = 'UNIT_RIFLEMAN');

UPDATE Units
SET Moves = 4, Cost = 185,  Help = 'TXT_KEY_UNIT_JFD_SHIPOFTHELINE_HELP', Strategy = 'TXT_KEY_UNIT_JFD_SHIPOFTHELINE_STRATEGY'
