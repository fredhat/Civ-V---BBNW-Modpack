...
--------------------------------
UPDATE Units 
SET Help = 'TXT_KEY_UNIT_JFD_HELP_SWEDISH_HAKKAPELIITTA', Strategy = 'TXT_KEY_UNIT_JFD_SWEDISH_HAKKAPELIITTA_STRATEGY', Combat = 28, Moves = 5, ObsoleteTech = 'TECH_STEAM_POWER', GoodyHutUpgradeUnitClass = 'UNITCLASS_AIRSHIP'
...
WHERE UnitType = 'UNIT_SWEDISH_HAKKAPELIITTA';
--------------------------------
-- Unit_FreePromotions
--------------------------------
INSERT INTO Unit_FreePromotions
		(UnitType,						PromotionType)
VALUES	('UNIT_SWEDISH_HAKKAPELIITTA',	'PROMOTION_SPAWN_GENERALS_I');
--==========================================================================================================================	
-- BUILDINGS
--==========================================================================================================================	
-- Buildings
...
SELECT	'BUILDING_JFD_WAR_ACADEMY',	DomainType,		Experience
...
INSERT INTO Improvements
		(Type,								Description, NearbyEnemyDamage, BuildableOnResources, DefenseModifier, Civilopedia, ArtDefineTag, CultureBombRadius, CreatedByGreatPerson, InAdjacentFriendly, PillageGold, PortraitIndex, IconAtlas, ShowInPedia)
SELECT	'IMPROVEMENT_JFD_SWEDISH_CITADEL',	Description, NearbyEnemyDamage, BuildableOnResources, DefenseModifier, Civilopedia, ArtDefineTag, CultureBombRadius, CreatedByGreatPerson, InAdjacentFriendly, PillageGold, PortraitIndex, IconAtlas, 0
FROM Improvements WHERE Type = 'IMPROVEMENT_CITADEL';

INSERT INTO Improvements
		(Type,								Description, BuildableOnResources, DefenseModifier, Civilopedia, ArtDefineTag, PillageGold, PortraitIndex, IconAtlas, ShowInPedia)
SELECT	'IMPROVEMENT_JFD_SWEDISH_FORT',		Description, BuildableOnResources, DefenseModifier, Civilopedia, ArtDefineTag, PillageGold, PortraitIndex, IconAtlas, 0
...
VALUES	('IMPROVEMENT_JFD_SWEDISH_CITADEL',	'YIELD_FOOD',		2),
		('IMPROVEMENT_JFD_SWEDISH_CITADEL',	'YIELD_PRODUCTION',	2),
		('IMPROVEMENT_JFD_SWEDISH_CITADEL',	'YIELD_CULTURE',	2),
		('IMPROVEMENT_JFD_SWEDISH_FORT',	'YIELD_FOOD',		1),
		('IMPROVEMENT_JFD_SWEDISH_FORT',	'YIELD_PRODUCTION',	1),
		('IMPROVEMENT_JFD_SWEDISH_FORT',	'YIELD_CULTURE',	1);
...
INSERT INTO Improvement_Yields
		(ImprovementType,					YieldType, Yield)
SELECT	'IMPROVEMENT_JFD_SWEDISH_FORT', 	YieldType, Yield
...
INSERT INTO Improvement_ResourceTypes
		(ImprovementType,					ResourceType)
SELECT	'IMPROVEMENT_JFD_SWEDISH_FORT', 	ResourceType
...
INSERT INTO Improvement_ResourceType_Yields
		(ImprovementType,					ResourceType, YieldType, Yield)
SELECT	'IMPROVEMENT_JFD_SWEDISH_FORT', 	ResourceType, YieldType, Yield
...
INSERT INTO Belief_ImprovementYieldChanges
		(ImprovementType,					BeliefType,	YieldType, Yield)
SELECT	'IMPROVEMENT_JFD_SWEDISH_FORT',		BeliefType,	YieldType, Yield
FROM Belief_ImprovementYieldChanges WHERE ImprovementType = 'IMPROVEMENT_FORT';
--==========================================================================================================================	
-- LEADERS
--==========================================================================================================================	
-- Leaders
...
--------------------------------
DELETE FROM Civilization_Start_Region_Priority WHERE CivilizationType = 'CIVILIZATION_SWEDEN';	
