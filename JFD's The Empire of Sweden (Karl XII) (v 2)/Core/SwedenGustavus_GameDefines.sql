...
VALUES	('PROMOTION_JFD_REGAL_SHIP',		'TXT_KEY_PROMOTION_JFD_REGAL_SHIP',			'TXT_KEY_PROMOTION_JFD_REGAL_SHIP_HELP',		'AS2D_IF_LEVELUP',	1, 				59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_REGAL_SHIP'),
...
VALUES	('PROMOTION_JFD_REGAL_SHIP', 		'TERRAIN_COAST',	20,		20),
		('PROMOTION_JFD_CAROLEAN_TUNDRA',	'TERRAIN_SNOW',		25,		0),
		('PROMOTION_JFD_CAROLEAN_TUNDRA',	'TERRAIN_TUNDRA',	25,		0);
--==========================================================================================================================
-- UNITS
--==========================================================================================================================
-- Units
...
SELECT	'UNIT_JFD_REGAL_SHIP',	Class,	PrereqTech, RangedCombat, Range, Special, Combat, Cost, FaithCost, RequiresFaithPurchaseEnabled, Moves+1, 	CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_JFD_REGAL_SHIP',	'TXT_KEY_CIV5_JFD_REGAL_SHIP_TEXT', 'TXT_KEY_UNIT_JFD_REGAL_SHIP_STRATEGY',  'TXT_KEY_UNIT_HELP_JFD_REGAL_SHIP', Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_JFD_REGAL_SHIP', 0,					'JFD_UNIT_FLAG_REGAL_SHIP_ATLAS',	2, 				'JFD_SWEDEN_KARL_ATLAS',	MoveRate
FROM Units WHERE Type = 'UNIT_FRIGATE';

UPDATE Units 
SET Help = 'TXT_KEY_UNIT_HELP_JFD_SWEDISH_CAROLEAN', Strategy = 'TXT_KEY_UNIT_JFD_SWEDISH_CAROLEAN_STRATEGY'
...
--------------------------------
UPDATE Traits 
SET Description = 'TXT_KEY_TRAIT_JFD_DIPLOMACY_GREAT_PEOPLE', FreeUnit = 'UNITCLASS_SCIENTIST', FreeUnitPrereqTech = 'TECH_DYNAMITE', DOFGreatPersonModifier = 25
...
VALUES	('CIVILIZATION_JFD_SWEDEN_GUSTAV', 	'UNITCLASS_RIFLEMAN',	'UNIT_SWEDISH_CAROLEAN'),
