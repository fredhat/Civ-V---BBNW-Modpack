...
--==========================================================================================================================
INSERT INTO Units 	
			(Class, 					Type, 					Special,				CivilianAttackPriority,				Cost,	Moves,	Domain,			DefaultUnitAI,		Description, 					Help,								Strategy,								ShowInPedia, 	AdvancedStartCost,	UnitArtInfo, 					UnitFlagIconOffset,		UnitFlagAtlas,					PortraitIndex,	IconAtlas, 					MoveRate)
VALUES		('UNITCLASS_JFD_DISCIPLE',	'UNIT_JFD_DISCIPLE', 	'SPECIALUNIT_PEOPLE',	'CIVILIAN_ATTACK_PRIORITY_HIGH',	-1,		2,		'DOMAIN_LAND',	'UNITAI_WRITER',	'TXT_KEY_UNIT_JFD_DISCIPLE',	'TXT_KEY_UNIT_JFD_DISCIPLE_HELP',	'TXT_KEY_UNIT_JFD_DISCIPLE_STRATEGY',	0,				-1,					'ART_DEF_UNIT_JFD_DISCIPLE',	0,						'JFD_UNIT_FLAG_DISCIPLE_ATLAS',	2, 				'JFD_PAPAL_STATES_ATLAS',	'GREAT_PERSON');
...
SELECT		 Class, ('UNIT_JFD_SWISS_GUARD'), 	('POLICY_PIETY'), 	PrereqTech, 18, 		Cost, 90,		 1,								PurchaseOnly,	MoveAfterPurchase, Moves, CombatClass, Domain, DefaultUnitAI, ('TXT_KEY_UNIT_JFD_SWISS_GUARD'), ('TXT_KEY_CIV5_JFD_SWISS_GUARD_TEXT'), 	('TXT_KEY_UNIT_JFD_SWISS_GUARD_STRATEGY'), 	('TXT_KEY_UNIT_HELP_JFD_SWISS_GUARD'), 	MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, AdvancedStartCost, CombatLimit, XPValueDefense, UnitArtInfoEraVariation, ('ART_DEF_UNIT_JFD_SWISS_GUARD'), 	0,					('JFD_UNIT_FLAG_SWISS_GUARD_ATLAS'), 3, 				('JFD_PAPAL_STATES_ATLAS')
