...
VALUES		('BUILDINGCLASS_JFD_SWISS_GUARD_TOURISM', 	'BUILDING_JFD_SWISS_GUARD_TOURISM', 	'TXT_KEY_BUILDING_JFD_SWISS_GUARD_TOURISM'),
			('BUILDINGCLASS_JFD_CHAPEL_FAITH', 			'BUILDING_JFD_CHAPEL_FAITH', 			'TXT_KEY_BUILDING_JFD_CHAPEL_FAITH'),
...
INSERT INTO Buildings 	
			(Type, 								BuildingClass, Cost, Capital, NukeImmune, MinAreaSize, Defense, ArtInfoCulturalVariation, DisplayPosition, GreatWorkSlotType, GreatWorkCount, NeverCapture, Description, 								Civilopedia, 									Help, 	Strategy,											PortraitIndex, 	IconAtlas,	ShowInPedia)
SELECT		('BUILDING_JFD_APOSTOLIC_PALACE'), 	BuildingClass, Cost, Capital, NukeImmune, MinAreaSize, Defense, ArtInfoCulturalVariation, DisplayPosition, GreatWorkSlotType, GreatWorkCount, NeverCapture, ('TXT_KEY_BUILDING_JFD_APOSTOLIC_PALACE'), 	('TXT_KEY_BUILDING_JFD_APOSTOLIC_PALACE_TEXT'), Help, 	('TXT_KEY_BUILDING_JFD_APOSTOLIC_PALACE_STRATEGY'),	PortraitIndex, 	IconAtlas,	0
FROM Buildings WHERE (Type = 'BUILDING_PALACE');
	
INSERT INTO Buildings 	
			(Type, 								BuildingClass,						GreatWorkSlotType,					GreatWorkCount,	PrereqTech,	Cost, 		GoldMaintenance, 	MinAreaSize, NeverCapture, 	Description, 						Civilopedia, 						Help, 									Strategy,									ArtDefineTag, PortraitIndex, 	IconAtlas,					ShowInPedia)
SELECT		('BUILDING_JFD_CHAPEL_ART'),		('BUILDINGCLASS_JFD_CHAPEL_ART'),	('GREAT_WORK_SLOT_ART_ARTIFACT'),	1, 				null,		Cost-20, 	GoldMaintenance-1, 	MinAreaSize, NeverCapture, 	('TXT_KEY_BUILDING_JFD_CHAPEL'), 	('TXT_KEY_CIV5_JFD_CHAPEL_TEXT'),   ('TXT_KEY_BUILDING_JFD_CHAPEL_HELP'), 	('TXT_KEY_BUILDING_JFD_CHAPEL_STRATEGY'),	ArtDefineTag, 4, 				('JFD_PAPAL_STATES_ATLAS'),	0
FROM Buildings WHERE Type = 'BUILDING_TEMPLE';		

INSERT INTO Buildings 	
			(Type, 								BuildingClass,						GreatWorkSlotType, 					GreatWorkCount,	PrereqTech,	Cost, 		GoldMaintenance, 	MinAreaSize, NeverCapture, 	Description, 						Civilopedia, 						Help, 									Strategy,									ArtDefineTag, PortraitIndex, 	IconAtlas,					ShowInPedia)
SELECT		('BUILDING_JFD_CHAPEL_MUSIC'),		('BUILDINGCLASS_JFD_CHAPEL_MUSIC'),	('GREAT_WORK_SLOT_MUSIC'),  		1, 				null,		Cost-20, 	GoldMaintenance-1, 	MinAreaSize, NeverCapture, 	('TXT_KEY_BUILDING_JFD_CHAPEL'), 	('TXT_KEY_CIV5_JFD_CHAPEL_TEXT'),   ('TXT_KEY_BUILDING_JFD_CHAPEL_HELP'), 	('TXT_KEY_BUILDING_JFD_CHAPEL_STRATEGY'),	ArtDefineTag, 4, 				('JFD_PAPAL_STATES_ATLAS'),	0
FROM Buildings WHERE Type = 'BUILDING_TEMPLE';	
...
SELECT		('BUILDING_JFD_CHAPEL_WRITING'),	BuildingClass,						('GREAT_WORK_SLOT_LITERATURE'),		1, 				PrereqTech, Cost-20, 	GoldMaintenance-1, 	MinAreaSize, NeverCapture, 	('TXT_KEY_BUILDING_JFD_CHAPEL'), 	('TXT_KEY_CIV5_JFD_CHAPEL_TEXT'),   ('TXT_KEY_BUILDING_JFD_CHAPEL_HELP'), 	('TXT_KEY_BUILDING_JFD_CHAPEL_STRATEGY'),	ArtDefineTag, 4, 				('JFD_PAPAL_STATES_ATLAS')
FROM Buildings WHERE Type = 'BUILDING_TEMPLE';	
...
VALUES		('BUILDING_JFD_SWISS_GUARD_TOURISM', 	'BUILDINGCLASS_JFD_SWISS_GUARD_TOURISM',	'TECH_RADIO',		2,					 -1, 			 -1,   -1, 		  null, 		'TXT_KEY_BUILDING_JFD_SWISS_GUARD_TOURISM', 'TXT_KEY_BUILDING_JFD_SWISS_GUARD_TOURISM_HELP'),
			('BUILDING_JFD_CHAPEL_FAITH', 			'BUILDINGCLASS_JFD_CHAPEL_FAITH',			null,				0,					 -1, 			 -1,   -1, 		  null, 		'TXT_KEY_BUILDING_JFD_CHAPEL_FAITH',		'TXT_KEY_BUILDING_JFD_CHAPEL_FAITH_HELP');
--==========================================================================================================================	
...
VALUES		('BUILDING_JFD_CHAPEL_FAITH', 		'YIELD_FAITH', 		2),
			...
			('BUILDING_JFD_APOSTOLIC_PALACE', 	'YIELD_CULTURE', 	1),
