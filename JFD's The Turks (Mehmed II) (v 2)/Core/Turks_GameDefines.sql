...
VALUES	('PROMOTION_JFD_BOMBARD',	'TXT_KEY_PROMOTION_JFD_BOMBARD',	 'TXT_KEY_PROMOTION_JFD_BOMBARD_HELP',	'AS2D_IF_LEVELUP',	300,		1,					1, 				59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_BOMBARD');
--==========================================================================================================================
-- UNITS
--==========================================================================================================================
-- Units
...
SELECT	'UNIT_JFD_BOMBARD',		Class, 'TECH_GUNPOWDER', Combat-2, RangedCombat-2,	Range, Cost,   	1,						FaithCost,  	RequiresFaithPurchaseEnabled, Moves, HurryCostModifier, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_JFD_BOMBARD_DESC', 'TXT_KEY_JFD_BOMBARD_TEXT', 'TXT_KEY_JFD_BOMBARD_STRATEGY', 'TXT_KEY_JFD_BOMBARD_HELP',	MilitarySupport, MilitaryProduction, Pillage, ObsoleteTech, AdvancedStartCost, GoodyHutUpgradeUnitClass, CombatLimit, XPValueAttack, XPValueDefense, Conscription, 'ART_DEF_UNIT_JFD_BOMBARD',	'JFD_BOMBARD_FLAG_ART_ATLAS', 	0,					2, 				'JFD_TURKS_ATLAS',	MoveRate
FROM Units WHERE Type = 'UNIT_CANNON';

-- Janissary
UPDATE Units
SET Help = 'TXT_KEY_UNIT_HELP_JFD_JANISSARY', Strategy = 'TXT_KEY_UNIT_OTTOMAN_JFD_JANISSARY_STRATEGY', Combat = 25
...
VALUES	('POLICY_JFD_TURKS',		'TXT_KEY_TRAIT_JFD_TURKS',		2);
--==========================================================================================================================	
-- CIVILIZATIONS
--==========================================================================================================================	
-- Civilizations
