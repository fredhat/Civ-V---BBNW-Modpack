...
VALUES		('ART_DEF_UNIT_MC_CHINOOK_WHALER', 	'ART_DEF_UNIT_MEMBER_MC_CHINOOK_WHALER',	3);
--==========================================================================================================================
-- ArtDefine_UnitInfos
--==========================================================================================================================
...
VALUES		('ART_DEF_RESOURCE_MC_ORCA',			'Resource',		'Orca'),
			...
			('ART_DEF_RESOURCE_MC_BREEDING_GROUND',	'Resource',		'Breeding Ground');
--==========================================================================================================================
-- ArtDefine_Landmarks
--==========================================================================================================================
...
INSERT OR REPLACE INTO ArtDefine_StrategicView 
			(StrategicViewType,						TileType,	Asset) 
VALUES		('ART_DEF_RESOURCE_MC_BREEDING_GROUND',	'Resource',	'sv_MC_BreedingGround.dds');
--==========================================================================================================================
-- IconFontTextures
--==========================================================================================================================
...
VALUES		('ICON_FONT_TEXTURE_MC_ORCA',				'MC_OrcaFontIcons_22'),
			...
			('ICON_FONT_TEXTURE_MC_BREEDING_GROUND',	'MC_BreedingGroundFontIcons_22');
--==========================================================================================================================
-- IconFontMapping
--==========================================================================================================================
...
VALUES		('ICON_RES_MC_ORCA',			'ICON_FONT_TEXTURE_MC_ORCA',			1),
			...
			('ICON_RES_MC_BREEDING_GROUND',	'ICON_FONT_TEXTURE_MC_BREEDING_GROUND',	1);
--==========================================================================================================================
-- IconTextureAtlases
--==========================================================================================================================
...
VALUES		('MC_CHINOOK_ATLAS', 			256, 		'ChinookAtlas_256.dds',					6, 				1),
			...
			('MC_BREEDING_GROUND_ATLAS', 	256, 		'BreedingGroundAtlas_256.dds',			1, 				1),
			('MC_BREEDING_GROUND_ATLAS', 	80, 		'BreedingGroundAtlas_80.dds',			1, 				1),
			('MC_BREEDING_GROUND_ATLAS', 	64, 		'BreedingGroundAtlas_64.dds',			1, 				1),
			('MC_BREEDING_GROUND_ATLAS', 	45, 		'BreedingGroundAtlas_45.dds',			1, 				1),
