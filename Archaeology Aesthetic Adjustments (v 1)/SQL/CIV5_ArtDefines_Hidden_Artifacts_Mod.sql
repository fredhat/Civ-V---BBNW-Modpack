...
VALUES	('Any', 'Any',	0.8,	'ART_DEF_IMPROVEMENT_ARCHAEOLOGICAL_DIG',	'SNAPSHOT',		'ART_DEF_RESOURCE_ARTIFACTS',	'Archaeological_Dig.fxsxml',	1);

INSERT INTO ArtDefine_Landmarks
		(Era, 	State,	Scale,	ImprovementType,							LayoutHandler,	ResourceType,							Model,								TerrainContour)
VALUES	('Any',	'Any',	0.8,	'ART_DEF_IMPROVEMENT_ARCHAEOLOGICAL_DIG',	'SNAPSHOT',		'ART_DEF_RESOURCE_HIDDEN_ARTIFACTS',	'Hidden_Archaeological_Dig.fxsxml',	1);