...
INSERT INTO Units 	
			(Class, 						Type, 							ShowInPedia,	PrereqTech, Combat,	RangedCombat, 	Range,	Cost,	Moves,   CombatClass, 					Domain, DefaultUnitAI, Description, 						Civilopedia, 										Strategy, 								Help, 								Mechanized, Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, AdvancedStartCost, CombatLimit, XPValueDefense, UnitArtInfoEraVariation, UnitArtInfo, 						UnitFlagIconOffset, UnitFlagAtlas,					PortraitIndex, 	IconAtlas,					MoveRate)
SELECT		('UNITCLASS_JFD_MONITOR'),		('UNIT_JFD_MONITOR_RANGED'),	0,				null,		Combat,	36, 			3, 		Cost,	4,		 ('UNITCOMBAT_NAVALRANGED'), 	Domain, DefaultUnitAI, ('TXT_KEY_UNIT_JFD_MONITOR_RANGED'),	('TXT_KEY_CIVIL_WAR_SCENARIO_UNIT_MONITOR_TEXT'), 	('TXT_KEY_UNIT_JFD_MONITOR_STRATEGY'), 	('TXT_KEY_UNIT_HELP_JFD_MONITOR'), 	Mechanized, Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, AdvancedStartCost, CombatLimit, XPValueDefense, UnitArtInfoEraVariation, ('ART_DEF_UNIT_UNION_IRONCLAD'), 	1,					('CIVIL_WAR_UNIT_FLAG_ATLAS'),	9, 				('CIVIL_WAR_UNIT_ATLAS'),	MoveRate
FROM Units WHERE (Type = 'UNIT_IRONCLAD');
--==========================================================================================================================	
