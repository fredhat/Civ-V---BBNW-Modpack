...
VALUES		('JFD_DENMARK_NORWAY_ATLAS', 			256, 		'JFD_DenmarkNorwayAtlas_256.dds',			2, 				2),
			...
			('JFD_MEAD_HALL_ATLAS', 				256, 		'JFD_MeadHallAtlas_256.dds',				1, 				1),
			('JFD_MEAD_HALL_ATLAS', 				128, 		'JFD_MeadHallAtlas_128.dds',				1, 				1),
			('JFD_MEAD_HALL_ATLAS', 				80, 		'JFD_MeadHallAtlas_80.dds',					1, 				1),
			('JFD_MEAD_HALL_ATLAS', 				64, 		'JFD_MeadHallAtlas_64.dds',					1, 				1),
			('JFD_MEAD_HALL_ATLAS', 				45, 		'JFD_MeadHallAtlas_45.dds',					1, 				1),
			('JFD_MEAD_HALL_ATLAS', 				32, 		'JFD_MeadHallAtlas_32.dds',					1, 				1),
