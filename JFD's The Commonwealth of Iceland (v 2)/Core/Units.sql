...
VALUES		('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_01',	'GREAT_WORK_SKALD_1'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_02',	'GREAT_WORK_SKALD_2'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_03',	'GREAT_WORK_SKALD_3'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_04',	'GREAT_WORK_SKALD_4'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_05',	'GREAT_WORK_SKALD_5'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_06',	'GREAT_WORK_SKALD_6'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_07',	'GREAT_WORK_SKALD_7'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_08',	'GREAT_WORK_SKALD_8'),
			('UNIT_JFD_SKALD',	'TXT_KEY_JFD_SKALD_UNIQUE_NAME_09',	'GREAT_WORK_SKALD_9'),
