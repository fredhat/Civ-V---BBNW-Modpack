...
VALUES	('MISSION_PROPHET_FREE_POLICY', 	20,		199,			1,			'TXT_KEY_MISSION_PROPHET_FREE_POLICY', 	'TXT_KEY_MISSION_PROPHET_FREE_POLICY_HELP',	'TXT_KEY_MISSION_PROPHET_FREE_POLICY_DISABLED_HELP',	'ENTITY_EVENT_GREAT_EVENT',		'UNIT_ACTION_WRITE_TREATISE',	0);
--==========================================================================================================================
-- Units
--==========================================================================================================================	
INSERT INTO Units 	
...
SELECT		Class, 	('UNIT_JFD_FRANCISCA'), PrereqTech, 15,		 	Cost, 	FaithCost, 	RequiresFaithPurchaseEnabled, Moves, HurryCostModifier,	CombatClass, Domain, DefaultUnitAI, ('TXT_KEY_UNIT_JFD_FRANCISCA'), ('TXT_KEY_CIV5_JFD_FRANCISCA_TEXT'), ('TXT_KEY_UNIT_JFD_FRANCISCA_STRATEGY'), ('TXT_KEY_UNIT_JFD_FRANCISCA_HELP'),	MilitarySupport, MilitaryProduction, Pillage, ObsoleteTech, AdvancedStartCost, GoodyHutUpgradeUnitClass, CombatLimit, XPValueAttack, XPValueDefense, Conscription, ('ART_DEF_UNIT_HAND_AXE_BARBARIAN'), ('EXPANSION2_UNIT_FLAG_ATLAS'), 	9,					3, 				('JFD_THE_FRANKS_ATLAS'), 	MoveRate
...
INSERT INTO Unit_FreePromotions 
			(UnitType, 				PromotionType)
VALUES		('UNIT_JFD_FRANCISCA', 	'PROMOTION_JFD_HAND_AXE');
--==========================================================================================================================
-- Unit_UniqueNames
--==========================================================================================================================
